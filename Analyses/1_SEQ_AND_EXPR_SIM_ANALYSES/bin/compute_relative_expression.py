...
parser = argparse.ArgumentParser(description="Script to compute the relative expression across tissues")
...
### Remove Adipose from input, if present ###
if "Adipose" in list(my_df.columns.values):
  my_df = my_df.drop(columns=["Adipose"])
#############################################
